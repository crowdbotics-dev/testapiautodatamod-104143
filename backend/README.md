...
## Project Structure
    ...
    ├── testapiautodatamod_104143  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_104143`
...
2. Clone this repo and `cd testapiautodatamod_104143`
